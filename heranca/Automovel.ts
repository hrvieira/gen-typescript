...
export class Automovel extends Terrestre{
     ...
     * @return {number}
     */
	public get_numeroPortas(): number {
     ...
     * @param {number} value
     */
	public set_numeroPortas(value: number) {
     ...
     * @param {number} value
     */
	public set_marchas(value: number) {
		this._marchas = value;
	}
